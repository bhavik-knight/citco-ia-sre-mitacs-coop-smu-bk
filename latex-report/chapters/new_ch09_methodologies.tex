...
\begin{enumerate}
    ...
    \item \textbf{Saturation} --- \emph{How full is the service?}
          Saturation is the most relevant signal to the April~17,~2026,
...
various stages of the request lifecycle.
...
available in any OSS tool). These account for 9--10\% of
...
\$77/month. Application Signals (the path to 80\% parity) require deploying
