...
\hline
\endfoot
\rowcolor{tablerowA} CloudWatch Alarms & 0 alarms on any IA resource & Dynamic alarms across 7 AWS service categories \\
\rowcolor{tablerowB} Centralized Dashboard & None & Multiple rows and panels (Grafana AMG) \\
...
A key framing question for my co-op placement --- introduced earlier in the report
and developed here in methodological
