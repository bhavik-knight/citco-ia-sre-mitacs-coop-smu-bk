...
\caption{Request Flow Through Monitored Services --- Golden Signals at Each Stage}
...
At the commencement of my co-op placement in Mar~2026, the IA-SRE team's
...
\begin{table}[!htbp]
\centering
\caption{Observability Gap Analysis --- Pre- vs.\ Post-Co-op Placement}
...
\hline
CloudWatch Alarms & 0 alarms on any IA resource & Dynamic alarms across 7 AWS service categories \\
Centralized Dashboard & None & Multiple rows and panels (Grafana AMG) \\
...
A key framing question for my co-op placement --- introduced in
...
\rowcolors{2}{tablerowA}{tablerowB}
\small  % Reduce font size slightly to help fit
\begin{tabularx}{\textwidth}{Xp{1.3cm}p{1.3cm}p{1.3cm}p{2.0cm}p{1.3cm}}
\hline
...
and Chapter~\ref{chap:achievements} to contextualize what the PoC does and does
not cover.
