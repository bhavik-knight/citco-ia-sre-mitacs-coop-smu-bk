...
into technical and non-technical categories to reflect the expected dual competency
development of an MCDA industry placement.
...
\begin{itemize}
    ...
    \item \textbf{Observability, Monitoring, and the Four Golden Signals.}
          ...
          goal emerged from discussions with Ms.\ Labos (SRE mentor) on
...
\begin{itemize}
    ...
    \item \textbf{Scrum and Engineering Leadership.}
          ...
          translate verbal requirements from Mr.\ Deotale into structured JIRA
          stories with clear acceptance criteria and subtask decomposition,
          and develop task estimation and prioritization skills in a
          production engineering environment.

    \item \textbf{Cross-Functional and Cross-Time Zone Collaboration.}
