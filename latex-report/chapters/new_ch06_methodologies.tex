...
\begin{itemize}
    ...
    \item \textbf{MSK consumer lag SLO}: The Kafka consumer lag for
          ...
          was derived from the April~17 post-mortem: the system reached
...
At the commencement of my internship in March~2026, the IA-SRE team's
...
\begin{itemize}
    ...
    \item \textbf{Incomplete Container Insights coverage.} Of the six
          ...
          (\texttt{meridian-compute-cluster}, enabled since July~2024)
    ...
    \item \textbf{No MSK consumer lag monitoring.} Despite Kafka
          ...
          April~17 incident --- no metric or alarm existed for this
...
\midrule
CloudWatch Alarms & 0 alarms on any IA resource & 38 alarms across 7 service categories \\
\midrule
...
\midrule
Resource Inventory & Manual (Confluence) & Automated REST API (119 Lambda, 22 ECS, 83 EC2) \\
\midrule
...
\paragraph{Incident Post-Mortem (April 17, 2026).}
...
IISS-706 hotfix on June~8, 2026. The CAIS Deadline incident revealed
