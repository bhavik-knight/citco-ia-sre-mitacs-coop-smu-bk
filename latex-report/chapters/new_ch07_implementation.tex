...
\begin{itemize}
    ...
    \item \textbf{MSK alarms}: \texttt{EstimatedMaxTimeLag} exceeding
          ...
          addresses the Apr~17 incident: it would have fired within
...
what had been understood informally since the Apr~17 incident: the IA team
...
\begin{enumerate}
    ...
    \item \textbf{\texttt{ia-sre-msk-alarms}} --- MSK consumer lag alarm on
          ...
          Apr~17 incident invisible until business users flagged it.
\end{enumerate}
...
directly implementing the alarm that would have detected the Apr~17 incident.
...
because OpenSearch was the bottleneck in the Apr~17 incident. I wired a JVM heap
