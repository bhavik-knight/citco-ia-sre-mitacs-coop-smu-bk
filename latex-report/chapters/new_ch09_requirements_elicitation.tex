...
FR2 & Dashboard displays ECS CPU and memory utilisation per cluster and service & Container Insights + ECS rows (IISS-487, IISS-483) \\
...
FR5 & CloudWatch alarms provisioned for all monitored resource types with SNS routing to SRE team & 38 alarms via CloudFormation (IISS-487) \\
...
NFR4 & Inventory API automated test coverage & $\geq$95\% & 99\% (562 tests) \\
