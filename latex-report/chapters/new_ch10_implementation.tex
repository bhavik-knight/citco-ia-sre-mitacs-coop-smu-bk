...
functional even during AWS service degradation events. I accompanied 
the feature with \textbf{automated tests} covering the registry
...
\begin{itemize}
    ...
    \item \textbf{IAM role model}: A \textbf{16-role agent permission
          ...
          Figure~\ref{fig:iam_role_model} shows the three-role IAM
...
Throughout the internship I participated in dedicated RPA production support
...
I completed four full support rotations during the internship:
...
% ────────────────────────────────────────────────────────────
\section{Work Stream 5: RPA LLM Agent --- Ask Citco RPA (IISS-824)}
...
% ────────────────────────────────────────────────────────────
\section{Work Stream 6: Citco Enterprise Custom UI Dashboards (Planning)}
\label{sec:enterprise_ui_dashboards}
% ────────────────────────────────────────────────────────────

Work Stream~6 represents planned future work to extend the existing
\texttt{ia-config-portal} application with two new dashboard pages.
During this internship period, I completed an \textbf{architectural
planning document} (IISS-919-IMPLEMENTATION-PLAN.md) that addresses
the limitations discovered in both Grafana AMG and CloudWatch dashboards.
Implementation is scheduled for the internship extension period
(Sep--Dec~2026).
...
Inventory Dashboard & IISS-509 frontend for resource inventory & Planned \\
Monitoring Dashboard & IISS-919 config-driven monitoring UI & Planned \\
\hline
\end{tabularx}
\end{table}
...
\rowcolors{2}{tablerowA}{tablerowB}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.23\textwidth}>{\raggedright\arraybackslash}p{0.33\textwidth}>{\raggedright\arraybackslash}p{0.38\textwidth}}
\hline
