...
\rowcolors{2}{tablerowA}{tablerowB}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.10\textwidth}>{\raggedright\arraybackslash}p{0.49\textwidth}>{\raggedright\arraybackslash}p{0.39\textwidth}}
\hline
